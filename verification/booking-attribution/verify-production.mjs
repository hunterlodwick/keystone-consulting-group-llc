...
const evidence = { deployment: 'dpl_6XbaaCdzZ1wD7Nzjj1L5KBR3qRk9', codeCommit: '4bba68db0a13d1323f38e1ead20ef4eb9f0c26b7', pages: [], bookingPosts: 0, consoleErrors: [] };
...
writeFileSync(new URL('./production.json', import.meta.url), JSON.stringify(evidence, null, 2) + '\n');
