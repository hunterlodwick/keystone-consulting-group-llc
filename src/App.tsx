...
const SOLUTIONS_DATA = [
  { 
    ...
    icon: Code, 
    desc: "Websites built around how your customers decide, not a template. Designed to make the phone ring.",
    longDesc: "We build the whole range: business sites, landing pages, online stores, booking and enquiry flows, AI chat that answers at 2 AM. Interactive 3D where it actually earns its keep.",
    features: ["Custom business websites", "Online stores and e-commerce", "Booking, quotes and enquiry forms", "AI chat that books appointments", "High-conversion landing pages", "Mobile-first and fast", "Interactive 3D where it fits", "You own the site and the accounts"],
...
const NAV_DROPDOWNS = {
  ...
  marketing: {
    ...
    items: [
      { name: 'Website Design', icon: Code, desc: 'Business sites, stores, bookings and AI chat', href: '/services/web-design' },
...
const HOMEPAGE_PRODUCTS: {
  ...
  },
  {
    ...
    icon: Code,
    desc: "Websites built around how your customers decide, not a template. Business sites, stores, bookings and AI chat.",
    linkTo: "/services/web-design",
...
const BUILD_DETAILS = [
  {
    ...
    intro: "We don't hand you a template. Every site is designed around what your customers actually need to decide, and built so the phone rings. Business sites, online stores, booking and enquiry flows, AI chat that answers at 2 AM.",
    columns: [
      {
        title: "What We Build",
        items: [
          "Custom business websites built around your brand",
          "Online stores and e-commerce with real checkout",
          "Booking, quote and enquiry flows that land in your inbox",
          "High-conversion landing pages for ads and campaigns",
          "AI chat that answers questions and books appointments",
          "Interactive 3D where it actually earns its keep",
        ],
      },
      {
        ...
        items: [
          ...
          "SEO foundations and Google Business Profile set up",
          "Copy written to convert, not to fill space",
          "You own the site and the accounts, no lock-in",
